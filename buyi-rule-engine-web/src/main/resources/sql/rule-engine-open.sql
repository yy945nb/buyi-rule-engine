...
INSERT INTO rule_engine_general_rule_publish (id, general_rule_id, general_rule_code, general_rule_name, workspace_id, workspace_code, data, status, version, loading_mode, value_type, create_time, update_time, deleted) VALUES (1513, 214, 'test', '测试', 2, 'test', '{"com.ymware.engine.core.rule.GeneralRule": {"id": 214, "code": "test", "name": "测试", "rule": {"com.ymware.engine.core.rule.Rule": {"id": null, "code": null, "name": null, "actionValue": {"com.ymware.engine.core.value.Constant": {"value": true, "valueType": {"com.ymware.engine.core.value.ValueType": "BOOLEAN"}}}, "description": null, "conditionSet": {"com.ymware.engine.core.condition.ConditionSet": {"conditionGroups": {"java.util.Collections$UnmodifiableRandomAccessList": [{"com.ymware.engine.core.condition.ConditionGroup": {"id": 2028, "name": "条件组", "orderNo": 1, "conditions": {"java.util.Collections$UnmodifiableRandomAccessList": [{"com.ymware.engine.core.condition.Condition": {"id": 149, "name": "测试条件", "orderNo": 0, "operator": {"com.ymware.engine.core.condition.Operator": "EQ"}, "leftValue": {"com.ymware.engine.core.value.InputParameter": {"valueType": {"com.ymware.engine.core.value.ValueType": "STRING"}, "inputParameterId": 166, "inputParameterCode": "name"}}, "rightValue": {"com.ymware.engine.core.value.Constant": {"value": "123", "valueType": {"com.ymware.engine.core.value.ValueType": "STRING"}}}}}]}}}]}}}}}, "version": "1.0", "description": null, "workspaceId": 2, "workspaceCode": "test", "defaultActionValue": null}}', 2, '1.0', 1, 'BOOLEAN', '2023-08-11 12:37:25', '2023-08-11 12:37:25', 0);
INSERT INTO rule_engine_general_rule_publish (id, general_rule_id, general_rule_code, general_rule_name, workspace_id, workspace_code, data, status, version, loading_mode, value_type, create_time, update_time, deleted) VALUES (1514, 214, 'test', '测试', 2, 'test', '{"com.ymware.engine.core.rule.GeneralRule": {"id": 214, "code": "test", "name": "测试", "rule": {"com.ymware.engine.core.rule.Rule": {"id": null, "code": null, "name": null, "actionValue": {"com.ymware.engine.core.value.Constant": {"value": true, "valueType": {"com.ymware.engine.core.value.ValueType": "BOOLEAN"}}}, "description": null, "conditionSet": {"com.ymware.engine.core.condition.ConditionSet": {"conditionGroups": {"java.util.Collections$UnmodifiableRandomAccessList": [{"com.ymware.engine.core.condition.ConditionGroup": {"id": 2028, "name": "条件组", "orderNo": 1, "conditions": {"java.util.Collections$UnmodifiableRandomAccessList": [{"com.ymware.engine.core.condition.Condition": {"id": 149, "name": "测试条件", "orderNo": 0, "operator": {"com.ymware.engine.core.condition.Operator": "EQ"}, "leftValue": {"com.ymware.engine.core.value.InputParameter": {"valueType": {"com.ymware.engine.core.value.ValueType": "STRING"}, "inputParameterId": 166, "inputParameterCode": "name"}}, "rightValue": {"com.ymware.engine.core.value.Constant": {"value": "123", "valueType": {"com.ymware.engine.core.value.ValueType": "STRING"}}}}}, {"com.ymware.engine.core.condition.Condition": {"id": 150, "name": "测试2", "orderNo": 1, "operator": {"com.ymware.engine.core.condition.Operator": "EQ"}, "leftValue": {"com.ymware.engine.core.value.Variable": {"valueType": {"com.ymware.engine.core.value.ValueType": "BOOLEAN"}, "variableId": 165}}, "rightValue": {"com.ymware.engine.core.value.Constant": {"value": true, "valueType": {"com.ymware.engine.core.value.ValueType": "BOOLEAN"}}}}}]}}}]}}}}}, "version": "2.0", "description": null, "workspaceId": 2, "workspaceCode": "test", "defaultActionValue": null}}', 1, '2.0', 1, 'BOOLEAN', '2023-08-11 12:38:36', '2023-08-11 12:38:36', 0);
...
-- =========================================================================
-- com.ymware.engine rule engine tables
-- =========================================================================

CREATE TABLE `tag_business_rule` (
  `id` bigint(20) NOT NULL COMMENT '主键ID',
  `target_tag_id` bigint(20) DEFAULT NULL COMMENT '目标标签ID',
  `rule_name` varchar(100) DEFAULT NULL COMMENT '规则名称',
  `rule_code` varchar(100) DEFAULT NULL COMMENT '规则编码',
  `cron_expression` varchar(100) DEFAULT NULL COMMENT 'cron表达式',
  `schedule_express` varchar(100) DEFAULT NULL COMMENT '调度表达式',
  `rule_sql` text DEFAULT NULL COMMENT '规则SQL',
  `data_source_code` varchar(50) DEFAULT 'DEFAULT_DS' COMMENT '数据源编码',
  ...
  `action_expression` text DEFAULT NULL COMMENT '执行动作',
  `priority` int(11) DEFAULT NULL COMMENT '执行优先级',
  ...
  `execution_count` int(11) DEFAULT NULL COMMENT '执行次数',
...
CREATE TABLE `tag_rule_execution_log` (
  ...
  `execution_status` varchar(50) DEFAULT NULL COMMENT '执行状态',
  `affected_users` int(11) DEFAULT NULL COMMENT '影响用户数',
  `error_message` text DEFAULT NULL COMMENT '错误信息',
  `start_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `execution_duration` int(11) DEFAULT NULL COMMENT '执行时长(秒)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='规则执行日志表';

CREATE TABLE `rule_engine_flow` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `code` varchar(100) NOT NULL COMMENT '工作流编码',
  `name` varchar(100) NOT NULL COMMENT '工作流名称',
  `description` varchar(255) DEFAULT NULL COMMENT '工作流描述',
  `workspace_id` int(11) DEFAULT NULL COMMENT '所属工作空间ID',
  `workspace_code` varchar(100) DEFAULT NULL COMMENT '所属工作空间编码',
  `config_json` text DEFAULT NULL COMMENT '规则引擎DAG流配置JSON',
  `status` int(11) DEFAULT '0' COMMENT '发布状态：0未发布，1已发布',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint(4) DEFAULT '0' COMMENT '逻辑删除',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_flow_code` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='规则引擎工作流配置表';

-- =========================================================================
-- Built-in JEXL and SQL functions for Rule Engine
-- =========================================================================

-- JEXL表达式函数
INSERT INTO rule_engine_function (id, name, description, executor, return_value_type, create_time, update_time, deleted) VALUES (100, 'JEXL表达式执行', '利用JEXL引擎执行动态脚本和计算表达式', 'jexlExpressionFunction', 'STRING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO rule_engine_function_param (id, function_id, param_name, param_code, value_type, create_time, update_time, deleted) VALUES (1001, 100, 'JEXL表达式', 'expression', 'STRING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO rule_engine_function_param (id, function_id, param_name, param_code, value_type, create_time, update_time, deleted) VALUES (1002, 100, '参数Map', 'params', 'COLLECTION', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- SQL数据查询函数
INSERT INTO rule_engine_function (id, name, description, executor, return_value_type, create_time, update_time, deleted) VALUES (101, 'SQL数据查询', '执行SQL语句获取动态数据，支持命名参数绑定', 'sqlExecutorFunction', 'STRING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO rule_engine_function_param (id, function_id, param_name, param_code, value_type, create_time, update_time, deleted) VALUES (1011, 101, 'SQL语句', 'sql', 'STRING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO rule_engine_function_param (id, function_id, param_name, param_code, value_type, create_time, update_time, deleted) VALUES (1012, 101, '数据源编码', 'dataSourceCode', 'STRING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO rule_engine_function_param (id, function_id, param_name, param_code, value_type, create_time, update_time, deleted) VALUES (1013, 101, '参数Map', 'params', 'COLLECTION', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- =========================================================================
-- Expression Engine SQL Schema
-- =========================================================================
...
-- ----------------------------
-- Table structure for gaia_workflow_template
-- ----------------------------
...
-- ----------------------------
-- Table structure for gaia_workflow
-- ----------------------------
...
-- ----------------------------
-- Table structure for gaia_workflow_version
-- ----------------------------
CREATE TABLE IF NOT EXISTS `gaia_workflow_version` (
    ...
    UNIQUE KEY `uk_workflow_version` (`workflow_code`, `version_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for gaia_workflow_log
-- ----------------------------
