...
import com.ymware.engine.mapper.RuleEngineConditionMapper;
...
public class ConditionServiceImpl implements ConditionService {
     ...
     */
    @Override
    public Long save(AddConditionRequest addConditionRequest) {
     ...
     */
    @Override
    public ConditionBody getById(Long id) {
     ...
     */
    @Override
    public ConditionBody getConditionResponse(RuleEngineCondition engineCondition, Map<Long, RuleEngineVariable> variableMap, Map<Long, RuleEngineInputParameter> ruleEngineInputParameterMap) {
        ConditionBody conditionResponse = new ConditionBody();
    ...
    public PageResult<ListConditionResponse> list(PageRequest<ListConditionRequest> pageRequest) {
        ...
        Map<Long, RuleEngineInputParameter> inputParameterMap = this.getConditionInputParameterMap(engineConditions);
        Map<Long, RuleEngineVariable> variableMap = this.getConditionVariableMap(engineConditions);
        // 类型转换处理
     ...
     * @return ConfigBean
     */
    public ConfigBean getConfigBean(RuleEngineCondition engineCondition, Map<Long, RuleEngineVariable> variableMap, Map<Long, RuleEngineInputParameter> inputParameterMap) {
        ConfigBean configBean = new ConfigBean();
     ...
     */
    @Override
    public Map<Long, RuleEngineVariable> getConditionVariableMap(Collection<RuleEngineCondition> ruleEngineConditions) {
        // 获取条件中的所有的变量数据
     ...
     */
    @Override
    public Map<Long, RuleEngineInputParameter> getConditionInputParameterMap(Collection<RuleEngineCondition> ruleEngineConditions) {
    ...
    public Boolean update(UpdateConditionRequest updateConditionRequest) {
        ...
        Long conditionId = updateConditionRequest.getId();
        // 更新条件
        RuleEngineCondition condition = new RuleEngineCondition();
