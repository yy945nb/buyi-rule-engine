...
public interface ConditionGroupService {
     ...
     * @return int
     */
    Long saveOrUpdateConditionGroup(SaveOrUpdateConditionGroup saveOrUpdateConditionGroup);
     ...
     */
    void saveConditionGroup(Long ruleId, List<ConditionGroupConfig> conditionGroup);
     ...
     * @param ruleIds 规则ids
     */
    void removeConditionGroupByRuleIds(List<Long> ruleIds);
     ...
     */
    List<ConditionGroupConfig> getConditionGroupConfig(Long ruleId);
