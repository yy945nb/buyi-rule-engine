...
import com.ymware.engine.mapper.RuleEngineConditionGroupConditionMapper;
...
public class ConditionGroupConditionServiceImpl implements ConditionGroupConditionService {
    ...
    public SaveConditionAndBindGroupResponse saveConditionAndBindGroup(SaveConditionAndBindGroupRequest saveConditionAndBindGroupRequest) {
        ...
        Long conditionId = this.conditionService.save(addConditionRequest);
        // 中间表插入一个关系数据
    ...
    public Boolean switchOrder(SwitchConditionOrderRequest switchOrderRequest) {
        Long fromConditionGroupId = switchOrderRequest.getFromConditionGroupId();
        Long toConditionGroupId = switchOrderRequest.getToConditionGroupId();
        ...
        Long toId = switchOrderRequest.getToId();
