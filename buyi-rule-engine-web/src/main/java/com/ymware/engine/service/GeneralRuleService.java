...
public interface GeneralRuleService {
     ...
     * @return 规则信息
     */
    GetGeneralRuleResponse getRuleConfig(Long id);
     ...
     * @return 规则定义信息
     */
    GeneralRuleDefinition getRuleDefinition(Long id);
     ...
     * @return 规则id
     */
    Long saveRuleDefinition(GeneralRuleDefinition ruleDefinition);
     ...
     * @return true
     */
    Boolean deleteHistoricalRules(Long id);
