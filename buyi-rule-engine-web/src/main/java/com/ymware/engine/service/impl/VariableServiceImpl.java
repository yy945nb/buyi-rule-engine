...
import com.ymware.engine.listener.event.VariableEvent;
...
public class VariableServiceImpl implements VariableService {
    ...
    private void validFormulaParam(Set<String> inputParameterCodes) {
        ...
        Long count = this.ruleEngineInputParameterManager.lambdaQuery()
     ...
     */
    public void saveFunctionParamValues(Long functionId, RuleEngineVariable engineVariable, List<ParamValue> paramValues) {
    ...
    public PageResult<ListVariableResponse> list(PageRequest<ListVariableRequest> pageRequest) {
        ...
        List<ListVariableResponse> collect = records.stream().map(m -> {
            ...
            if (m.getType().equals(VariableType.FUNCTION.getType())) {
                listVariableResponse.setFunctionName(functionMap.get(Long.valueOf(m.getValue())));
            }
     ...
     */
    @Override
    public GetVariableResponse get(Long id) {
