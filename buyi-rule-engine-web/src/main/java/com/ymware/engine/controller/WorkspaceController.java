...
public class WorkspaceController {
     ...
     */
    @PostMapping("list")
    @Operation(summary = "用户有权限的工作空间列表")
    ...
    @Operation(summary = "查询工作空间AccessKey")
    ...
    @Operation(summary = "更新工作空间AccessKey")
    ...
    @Operation(summary = "通过工作空间id查询工作空间信息")
