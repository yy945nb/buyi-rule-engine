...
import com.ymware.engine.vo.condition.group.DeleteConditionGroupRequest;
...
public class ConditionGroupController {
    ...
    @Operation(summary = "保存或者更新条件组")
    public PlainResult<Long> saveOrUpdateConditionGroup(@RequestBody @Valid SaveOrUpdateConditionGroup saveOrUpdateConditionGroup) {
