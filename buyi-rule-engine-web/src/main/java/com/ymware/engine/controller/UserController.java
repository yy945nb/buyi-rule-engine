...
import com.ymware.engine.annotation.*;
import com.ymware.engine.enums.RateLimitEnum;
...
public class UserController {
    ...
    @PostMapping("delete")
    @Auth()
    @Operation(summary = "删除用户-(删除用户表信息，删除所有空间内该用户信息)")
