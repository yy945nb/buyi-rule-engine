package com.ymware.engine.config.rabbit;

import com.ymware.engine.common.config.rabbit.RabbitConstants;
 ...
 */
@Slf4j
@ConditionalOnBean(com.ymware.engine.config.rabbit.RabbitConfig.class)
@Component
public class RabbitTopicConfig {
    ...
    public Queue systemLogQueue() {
        return new Queue(RabbitQueueConstants.SYSTEM_LOG_QUEUE, true);
    }
}
