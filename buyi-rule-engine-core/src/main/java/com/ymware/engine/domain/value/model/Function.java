...
import com.ymware.engine.domain.rule.service.FunctionExecutor;
...
import com.ymware.engine.annotation.FunctionCacheable;
import com.ymware.engine.cache.FunctionCache;
import com.ymware.engine.cache.KeyGenerator;
...
public class Function implements Value {
    ...
    public Function(Long id, Object abstractFunction, ValueType valueType, Map<String, Value> params) {
