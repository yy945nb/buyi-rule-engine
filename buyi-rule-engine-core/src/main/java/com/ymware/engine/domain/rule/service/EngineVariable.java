...
public class EngineVariable implements Closeable {
     ...
     */
    private final Map<Long, Value> variableMap = new ConcurrentHashMap<>();
     ...
     * @return 变量值
     */
    public Value getVariable(@NonNull Long id) {
     ...
     * @param value 变量值
     */
    public void addVariable(Long id, Value value) {
     ...
     */
    public void addMultipleVariable(@NonNull Map<Long, Value> variableMap) {
