...
public class VariableMessageListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(),
            exchange = @Exchange(value = RabbitTopicConstants.VAR_EXCHANGE, type = ExchangeTypes.TOPIC),
            key = RabbitTopicConstants.VAR_TOPIC_ROUTING_KEY)
    )
    public void message(VariableMessageBody variableMessageBody) {
        ...
        Long id = variableMessageBody.getId();
