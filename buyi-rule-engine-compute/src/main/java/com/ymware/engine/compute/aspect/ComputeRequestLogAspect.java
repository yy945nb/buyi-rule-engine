 ...
 */
package com.ymware.engine.compute.aspect;

import com.ymware.engine.common.util.HttpServletUtils;
...
@Aspect
@Slf4j
public class ComputeRequestLogAspect {
     ...
     * @throws Throwable .
     */
    @Around("execution(* com.ymware.engine.compute.controller..*.*(..)) || execution(* com.ymware.engine.compute.config.MonitorController.*(..))")
