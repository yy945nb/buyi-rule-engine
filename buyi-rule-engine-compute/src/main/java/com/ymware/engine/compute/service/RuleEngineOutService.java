...
import com.ymware.engine.compute.service.impl.BatchExecuteTask;
import com.ymware.engine.compute.vo.*;
...
public abstract class RuleEngineOutService {
    ...
    public Object batchExecute(BatchExecuteRequest batchExecuteRequest) {
        ...
        ConcurrentLinkedQueue<BatchExecuteResponse> outputs = new ConcurrentLinkedQueue<>();
