 ...
 */
package com.ymware.engine.compute.listener;
...
import com.ymware.engine.compute.service.GeneralRulePublishService;
...
public class GeneralRuleMessageListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(),
            exchange = @Exchange(value = RabbitTopicConstants.RULE_EXCHANGE, type = ExchangeTypes.TOPIC),
            key = RabbitTopicConstants.RULE_TOPIC_ROUTING_KEY)
    )
