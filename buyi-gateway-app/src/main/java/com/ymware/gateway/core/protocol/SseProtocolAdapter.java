 ...
 * </p>
 * <p>
 * <b>实现约束</b>：所有实现类必须继承 {@link AbstractSseProtocolAdapter}，
 * 不得直接实现本接口，否则将缺少 SDK 桥接逻辑。
 * </p>
 */
public interface SseProtocolAdapter extends com.ymware.gateway.sdk.protocol.ProtocolAdapter {
     ...
     * <p>所有实现类均通过 {@link AbstractSseProtocolAdapter} 桥接到 SDK，无默认实现。</p>
     */
