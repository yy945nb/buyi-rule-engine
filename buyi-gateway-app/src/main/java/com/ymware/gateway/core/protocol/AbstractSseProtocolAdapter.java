 ...
 * SSE 协议适配器抽象基类
 * <p>
 * 封装 App SseProtocolAdapter 与 SDK ProtocolAdapter 之间的通用桥接逻辑：
 * <ul>
 ...
 * </p>
 */
public abstract class AbstractSseProtocolAdapter implements SseProtocolAdapter {

    protected final ObjectMapper objectMapper;

    protected AbstractSseProtocolAdapter(ObjectMapper objectMapper) {
